...
- **เอกสารสำหรับคน** มีแค่ README (ภาพรวม + ตาราง "เอกสาร" เป็นศูนย์รวมลิงก์), `docs/setup-guide.md`, `docs/demo-guide.md` (วิธีทดลองใช้ทุกกรณี — แก้ UI / ข้อความบนหน้าจอแล้วต้องแก้ตาม), `docs/monitoring.md`, `skills/crm-copilot/SKILL.md`, แผน และ AI-usage log — ไม่เพิ่มไฟล์ใหม่ถ้าใส่ในไฟล์เดิมได้; ลิงก์ข้ามไฟล์ใช้ระดับไฟล์เท่านั้น อ้างหัวข้อในไฟล์อื่นเป็นข้อความ (เช่น "setup-guide ข้อ 5.4") เพราะ anchor ภาษาไทยพังเงียบๆ เมื่อแก้หัวข้อ
